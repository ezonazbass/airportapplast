...
function testFlightSearch() {
    return __awaiter(this, void 0, void 0, function () {
        var searchParams, flights, cities, airlines, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    searchParams = {
                        from: 'IST', // İstanbul Havalimanı
                        to: 'LHR', // Londra Heathrow
                        departureDate: '2024-05-01',
                        isRoundTrip: true,
                        returnDate: '2024-05-08'
                    };
                    console.log('Uçuşlar aranıyor...');
                    return [4 /*yield*/, api_1.apiService.searchFlights(searchParams)];
                case 1:
                    flights = _a.sent();
                    console.log('Bulunan uçuşlar:', JSON.stringify(flights, null, 2));
                    // Şehirleri test et
                    console.log('\nŞehirler alınıyor...');
                    return [4 /*yield*/, api_1.apiService.getCities()];
                case 2:
                    cities = _a.sent();
                    console.log('Bulunan şehirler:', cities);
                    // Havayollarını test et
                    console.log('\nHavayolları alınıyor...');
                    return [4 /*yield*/, api_1.apiService.getAirlines()];
                case 3:
                    airlines = _a.sent();
